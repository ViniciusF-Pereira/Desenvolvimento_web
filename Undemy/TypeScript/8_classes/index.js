...
class Super__Human extends Human {
    poderes;
    super_hero__name;
    constructor(name, surname, job, age, poderes, super_hero__name) {
...
const Vinicius__Hero = new Super__Human(Vinicius__Human.name, Vinicius__Human.surname, Vinicius__Human.job, Vinicius__Human.age, Super__Hero__Ketchup_Man.poderes, Super__Hero__Ketchup_Man.super_hero__name);
